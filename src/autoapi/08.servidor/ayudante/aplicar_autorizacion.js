const validar_regla = function (regla_presunta) {
    ...
    if ((typeof regla_presunta.incluir + al_pre_aceptar + al_post_aceptar + al_pre_rechazar + al_post_rechazar) === "undefinedundefinedundefinedundefined") throw new Error("Se requiere un objeto con función «al_pre_aceptar», «al_post_aceptar», «al_pre_rechazar» o «al_post_rechazar» para crear una «regla de autorización»");
    return true;
}
