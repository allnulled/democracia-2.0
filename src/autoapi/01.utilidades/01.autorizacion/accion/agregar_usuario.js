module.exports = async function (nombre = false, contrasenya = false, correo = false) {
    try {
        ...
        Formatear_parametros: {
            ...
            contrasenya_sanitizada = this.utilidades.datos.funcion.sanitizar_valor(contrasenya);
            correo_sanitizado = this.utilidades.datos.funcion.sanitizar_valor(correo);
        }
