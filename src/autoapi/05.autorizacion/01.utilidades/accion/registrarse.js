module.exports = async function (nombre, correo, contrasenya, otros = "{}") {
    try {
        ...
        Formatear_parametros: {
            nombre_formateado = this.datos.utilidades.funcion.sanitizar_valor(nombre);
            contrasenya_formateado = this.datos.utilidades.funcion.sanitizar_valor(contrasenya);
            correo_formateado = this.datos.utilidades.funcion.sanitizar_valor(correo);
            token_de_confirmacion_formateado = this.datos.utilidades.funcion.sanitizar_valor(token_de_confirmacion);
            otros_formateado = this.datos.utilidades.funcion.sanitizar_valor(otros);
        }
