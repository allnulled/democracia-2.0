module.exports = async function (tabla_nombre, tabla_index) {
    ...
    try {
        ...
        //this.utilidades.log("Esquema original: ", esquema);
        const consulta_de_creacion_de_tabla = this.datos.utilidades.funcion.obtener_sql_create_table_de_tabla(tabla_nombre);
        ...
        this.utilidades.error("this.datos.inicializacion.inicializar_esquema_de_datos_para_tabla", error);
        return error;
    }
}