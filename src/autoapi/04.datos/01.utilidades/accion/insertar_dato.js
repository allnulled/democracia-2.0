module.exports = async function (tabla, dato, autentificacion) {
    try {
        ...
        Aplicar_autorizador_al_pre_aceptar: {
            await this.servidor.ayudante.aplicar_autorizacion("insertar", "al_pre_aceptar", autentificacion, { tabla, dato, db, esquema });
        }
        let sql = undefined;
        ...
        Aplicar_autorizador_al_post_aceptar: {
            await this.servidor.ayudante.aplicar_autorizacion("insertar", "al_post_aceptar", autentificacion, { tabla, dato, db, esquema, sql, resultados: [resultado_1, resultado_2] });
        }
        return {
