module.exports = async function (tabla, id, dato, autentificacion) {
    try {
        ...
        Aplicar_autorizador_al_pre_aceptar: {
            await this.servidor.ayudante.aplicar_autorizacion("actualizar", "al_pre_aceptar", autentificacion, { tabla, id, dato, db, esquema });
        }
        let sql = undefined;
        ...
        Aplicar_autorizador_al_post_aceptar: {
            await this.servidor.ayudante.aplicar_autorizacion("actualizar", "al_post_aceptar", autentificacion, { tabla, id, dato, sql, resultado: resultado_1, db, esquema });
        }
        return {
        ...
        Aplicar_autorizador_al_rechazar: {
            await this.servidor.ayudante.aplicar_autorizacion("actualizar", "al_rechazar", autentificacion, { tabla, id, dato, error });
        }
        throw error;
    }
};